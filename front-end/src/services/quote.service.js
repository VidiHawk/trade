...
let getRates = () => {
  return currencyCloud.retry(() => {
    return currencyCloud.rates.find(checkRate.getRates).then((res) => {
...
let getQuote = () => {
  return currencyCloud.retry(() => {
    return currencyCloud.rates.get(checkRate.getQuote).then((res) => {
...
let logout = () => {
  return currencyCloud.authentication.logout().then(() => {
    console.log("logout\n");
  });
};
